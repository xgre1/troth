...
3. Persist the SYNTHESIS (not every micro-step) to substrate:
   - `engram_record({ statement: "<one-sentence synthesis of the reasoning>", salience: 1, scope: "reasoning" })`
4. Reply with the trace + the engram_id so the user can audit.
