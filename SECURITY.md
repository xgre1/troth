...
- troth is local-first: the substrate (`~/.troth/state.db`) and config live on the operator's machine. At-rest encryption of the substrate is on the roadmap and is documented as a current limit.
