...
async function run(args, ctx) {
  ...
  // AUTO mode gets a second door. "Plan first, key as fallback" resolved
  // once at link-time means that with the plan linked but its lane down,
  // the Google key sits unused while the user gets an error (web ChatGPT
  // fine, Codex lane overloaded, fresh Gemini key on
