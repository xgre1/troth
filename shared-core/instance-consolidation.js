...
function buildCombinedPrompt(turns) {
  ...
  return [
    ...
    '   it stays owed until the user says it is done. date_iso: YYYY-MM-DD',
    '   only when the statement pins it; otherwise null — NEVER guess dates.',
    '   turn_idxs: the [N] indexes attesting the entry. Mandatory.',
    '',
