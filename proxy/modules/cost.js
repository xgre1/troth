...
//
// Real provider rates (April 2026, $/M tokens). Updated when verified.
...
const RATES = {
  ...
  'gpt-5':                 { in: 0.625, out: 5.00, cached_in: 0.06 },
  // Google
  'gemini-3.1-pro':        { in: 2.00, out: 12.00, cached_in: 0.20 },
  'gemini-3-flash':        { in: 0.30, out: 2.00, cached_in: 0.03 },
  ...
  'glm-5.1':               { in: 0.95, out: 3.15, cached_in: 0.10 },
  ...
  // xAI (Grok). Verified  against docs.x.ai/developers/pricing (below-200k
  // tier). No published cached-input rate, so cached_in mirrors the input rate.
  'grok-4.3':                   { in: 1.25, out: 2.50,  cached_in: 1.25 },
  'grok-4.5':                   { in: 2.00, out: 6.00,  cached_in: 2.00 },
  'grok-build-0.1':             { in: 1.00, out: 2.00,  cached_in: 1.00 },
  ...
  'deepseek-ai/DeepSeek-V3-0324': { in: 0.14, out: 0.28, cached_in: 0.014 },
  // OpenRouter (free)
