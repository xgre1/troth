...
t('a document the operator keeps is knowledge', () => {
  assert.ok(k.isKnowledgeFile('/Users/x/Documents/research/llama-cpp-notes.md'));
  assert.ok(k.isKnowledgeFile('/home/x/Desktop/plan-2026.md'));
});

t("the assistant's own scratch never is", () => {
  for (const p of [
    '/Users/x/.claude/projects/-Users-x/abc/tool-results/mcp-foo.txt',
    '/Users/x/.claude/projects/-Users-x/hook-5b61-7-additionalContext.txt',
    '/Users/x/.claude/projects/-Users-x/abc.jsonl',
    '/private/tmp/claude-501/-Users-x/sess/scratchpad/notes.md',
    '/tmp/troth-test-home-123-ab/.troth/state.md',
    '/Users/x/.troth/telemetry/hook-timing.jsonl'
  ]) {
...
t('a project folder that merely contains the word is untouched', () => {
  assert.ok(!k.isAssistantScratch('/Users/x/Documents/scratchpad-app/README.md'));
  assert.ok(k.isKnowledgeFile('/Users/x/Documents/scratchpad-app/README.md'));
});
