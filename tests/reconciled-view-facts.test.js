...
// renders names only. Measured on the operator's own memory, 2026-09-03.
...
const items = [
  { source: 'instance-pool', id: 'i1', statement: '[instance] activity: run troth — Running a 102-question benchmark with Qwen 3.8 [completed] (attested ×1)', refs: ['dialogue.turn:r5'], _kind: 'activity', _entity: 'troth', _cos: 0.21 },
  ...
  { source: 'instance-pool', id: 'i3', statement: '[instance] activity: holding crypto trading — Checking crypto trading using automatic bots [completed] (attested ×1)', refs: [], _kind: 'activity', _entity: 'crypto trading', _cos: 0.24 },
  { source: 'identity-cast', id: 'c1', statement: '[cast] Anthropic — entity blocking the user\'s fable (also: contosso, i mana poutanes gioi tis anthropic)', link_names: ['anthropic'] },
  { source: 'identity-cast', id: 'c2', statement: '[cast] orea — colleague (also: sinexise)', link_names: ['orea'] },
  { source: 'identity-cast', id: 'c3', statement: '[cast] Nikos — colleague', link_names: ['stamatis'] },
  { source: 'commitment', id: 'r1', statement: 'User is currently employed by Northwind, earning €700/month for 2 days/week of work.', ts: MAY },
  { source: 'commitment', id: 'r2', statement: 'CORRECTED (supersedes the older figure): the\'s Northwind part-time deal is €600/month for 2 days a week, Wednesday and Thursday.', ts: SEP },
  { source: 'dialogue-window', id: 'r5', statement: 'user: run the 102 with qwen 3.8', ts: SEP },
];
